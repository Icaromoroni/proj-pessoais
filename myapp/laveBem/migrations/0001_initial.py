    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.CharField(choices=[('1', 'Gerente'), ('2', 'Atendente'), ('3', 'Helper')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solicitacao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='atendimentos', to='laveBem.agendamento')),
            ],
        ),
        migrations.AddField(
